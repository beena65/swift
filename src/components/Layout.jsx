...
const CustomLayout = () => {
    ...
    const handleDelete = (record) => {
        console.log("delete is clicked", record);
    ...
    return (
        <Layout style={{minHeight: "100vh"}}>
            ...
            >
                ...
                <Menu theme="white" defaultSelectedKeys={selectedKeys} selectedKeys={selectedKeys} mode="inline">
            ...
            <Layout>
                ...
                >
                    ...
                    >
                        ...
                        <Badge count={notificationsCount} style={{width: "auto", height: "auto", fontSize: "13px"}}>
                            <div
                                style={{
                    ...
                    {content && (
                        <div>
                            {activeMenuItem === "5" && (
                                <>
                                    <div>
                                        <span style={{color: "#888"}}>Home</span> /<span>List</span>
                                    </div>
